    ...
    <Modal open={open} onClose={onClose}>
      <Box sx={style}>
        ...
        <form onSubmit={handleSubmit} style={{ marginTop: 16 }}>
          ...
          <TextField label="Content" name="content" value={form.content} onChange={handleChange} fullWidth margin="normal" multiline rows={5} required />
          <Box sx={{ my: 2 }}>
            {form.imageUrl ? (
              <Box>
                <img src={form.imageUrl} alt="Article" style={{ width: 120, height: 120, objectFit: 'cover', borderRadius: 8 }} />
                <Button color="error" onClick={handleRemoveImage} sx={{ ml: 2 }}>Remove Image</Button>
              </Box>
            ) : (
